...
<figure class="video_container">
  <video controls="true" allowfullscreen="true">
    <source src="{{ site.baseurl }}/images/sgd4_sin_f5.mp4" type="video/mp4">
  </video>
</figure>
...
<figure class="video_container">
  <video controls="true" allowfullscreen="true">
    <source src="{{ site.baseurl }}/images/sgd4_sin_f2.mp4" type="video/mp4">
  </video>
</figure>

<figure class="video_container">
  <video controls="true" allowfullscreen="true">
    <source src="{{ site.baseurl }}/images/sgd4_sin_f15.mp4" type="video/mp4">
  </video>
</figure>
...
<figure class="video_container">
  <video controls="true" allowfullscreen="true">
    <source src="{{ site.baseurl }}/images/sgd4_sin_f12.mp4" type="video/mp4">
  </video>
</figure>
...
<figure class="video_container">
  <video controls="true" allowfullscreen="true">
    <source src="{{ site.baseurl }}/images/sgd4_sin_f06.mp4" type="video/mp4">
  </video>
</figure>
...
<figure class="video_container">
  <video controls="true" allowfullscreen="true">
    <source src="{{ site.baseurl }}/images/sgd4_sin_f05.mp4" type="video/mp4">
  </video>
</figure>
